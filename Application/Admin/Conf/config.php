...
define("CUSTOM_SYSTOM_LOGIN_TITLE","书吧管理员管理系统");  //登录页标题
define("CUSTOM_SYSTOM_LOGIN_SUBTITLE","Librarian Management System");  //登录页副标题
define("CUSTOM_SYSTOM_FIND_SUBTITLE","reset password");  //后台栏目标题
define("CUSTOM_SYSTOM_WEBTITLE","后台管理系统");  //后台通用网页名
define("CUSTOM_SYSTOM_MENU","书吧管理员管理系统");  //后台栏目标题
